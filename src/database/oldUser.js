...
/*     -- TABLE OF CONTENTS --
    ...
    NOMENCLATURE:
    -> An image table of user username is imageTable_userID
    -> A following table of user is isFollowing_userID
    -> A followed by table of user is isFollowedBy_userID
    -> A comment table for user, image, is commentsFor_userID_imageID
    -> A like table for user, image, is likesFor_userID_imageID
